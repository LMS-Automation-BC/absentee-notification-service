...
const attendance_sessions = (classid, start, end) =>
 ...
 //class365
 const class365 = {
  baseUrl:"https://brookescollege.classe365.com/",
  key:"Basic YnJvb2tlc2NvbGxlZ2U6TmFON3grbXo2UjhiI294Nw=="
 }

 export{api_key, classes, yesterday, user, attendance_sessions, attendance_records, class365}